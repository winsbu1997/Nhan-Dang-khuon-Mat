...
def evaluate(weight_file_path,prob_thresh=0.5, nms_thresh=0.1, lw=3, display=False):
  ...
  with tf.Session() as sess:
    ...
    while True:
      ...
      raw_img = cv2.resize(raw_img,(600,400))
...
def main():
  ...
  argparse.add_argument('--weight_file_path', type=str, help='Pretrained weight file.', default="./pickle_file/mat2tf.pkl")
